...
select last || first as name, wegith + 10 as weigth2 from tblComedian;

select first, nick, '코미디언', 100 from tblComedian;
...
-- tblCountry에는 어떤 대륙이 있습니까? > 종류 > 중복 제거!
...
select
    ...
    case
        ...
        -- else continent
        -- else name > 사용 금지 ** 하나의 속성(컬럼) 안에는 같은 도메인(성격, 표현)과 같은 자료형을 가지는 값이 들어간다.
        -- else population    
...
-- 직위별 성과급 지급 > 차등 지급 > 부장( * 2), 과장 ( * 1.7), 대리 ( * 1.5), 사원 ( * 1.2)
