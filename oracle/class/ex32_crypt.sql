...
/*
    ...
    - 암호화/복호화 기능 제공
    - D:\oraclexe\app\oracle\product\11.2.0\server\rdbms\admin
    - 터미널 열기 > sqlplus 실행
        - SQL> @dbmsobtk.sql
        - SQL> @prvtobtk.plb
...
-- 양방향 암호화
-- pkgCrypto.encrypt(암호화할 값, 공개키)
insert into tblUser values('test', '테스트', pkgCrypto.encrypt('12341234','java')); 
