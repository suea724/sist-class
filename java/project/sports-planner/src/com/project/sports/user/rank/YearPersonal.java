...
public class YearPersonal {
	...
	public static void rank() { // 연도별 개인 순위 포지션 선택
	...
	private static void selectBatterType() { // 타자 메뉴
	...
	private static void selectPitcherType() { // 투수 메뉴
	...
	private static void searchBatterPlayer() { // 선수검색
